...
class IE(Package):
    ...
    PATHS = [
        ("ProgramFiles", "Internet Explorer", "iexplore.exe"),  # Lance IE en background
        # ("ProgramFiles", "Mozilla Firefox", "firefox.exe"),  # Lance Firefox en background
    ...
    def start(self, target):
        ...
        return self.execute(
            ...
            # iexplore, args=['microsoft-edge:'+target], maximize=True, mode="iexplore"
        )
